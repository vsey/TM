...
class NetworkTopo(Topo):
    ...
    def build(self, **_opts):
        ...
        # define isps
        isp_user = self.addHost("isp_user", cls=LinuxRouter)
        isp_vpn = self.addHost("isp_vpn", cls=LinuxRouter)

        # define isp links
        self.addLink(
            isp_user, s1, intfName1="isp_user-s1", params1={"ip": "10.68.1.1/30"}
        )
        self.addLink(
        ...
        self.addLink(
            isp_vpn, s4, intfName1="isp_vpn-s4", params1={"ip": "10.68.4.1/30"}
        )
        self.addLink(
